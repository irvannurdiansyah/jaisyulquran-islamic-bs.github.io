  ...
  <body class="hold-transition login-page" style="background-image: url('img/bg3.png');">
            ...
            <div class='row'>
                <div class='col-12'>
                   <div class='alert alert-danger alert-dismissible'>
                        ...
                        <center><h4><i class='fa fa-warning '></i> PERINGATAN!</h4><i> Silahkan masukkan username dan password..!</i></center>
                    </div>
                </div>
            </div>
          </div>
    ...
    <div class="login-box" style="margin-top: 40px;">
      ...
      <div  class="login-box-body" style="border-top: 10px solid #3c8dbc;border-top-left-radius: 20px; box-shadow: 0px 3px 6px 0px #3c8dbc;">
        <p class="login-box-msg"><b>L O G I N </b></p>
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <a target="blank" href="lupa-password.php" class="btn btn-success btn-block"><i class="glyphicon glyphicon-lock"></i> Lupa Password?</a>
            </div>
          </div>
        </form>
      </div>
      ...
      <p class="text-center" style="background-color: #3c8dbc; color: #FFFFFF; border-bottom-right-radius: 20px; box-shadow: 0px 1px 6px 0px #3c8dbc;">
        <?php echo "$r[title]";?> - <?php echo "$r[sekolah]";?><br> Versi 1.0 <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?><br>
        <marquee>Pengembang <a target="_blank" href="#"><b style="color: #ffffff;">JQ Admin</b></marquee></a>
      </p>
    </div>
