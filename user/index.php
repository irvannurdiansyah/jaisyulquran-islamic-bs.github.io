    ...
    <div class="container">
      ...
      <section class="content-header">
        <h1>
          ...
          <small>Silahkan Cek Data nya ....</small>
        </h1>
        <ol class="breadcrumb">
      ...
      <section class="content">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="updatepelajar?id=<?php echo $users["id_session"];?>" class="small-box-footer">Update Identitas sekarang <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a target="blank" href="<?php echo $x["link"];?>?id=<?php echo $users["id_session"];?>" class="small-box-footer">Cetak Sekarang <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a target="blank" href="<?php echo $y["link"];?>?id=<?php echo $users["id_session"];?>" class="small-box-footer">Cetak Sekarang <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
